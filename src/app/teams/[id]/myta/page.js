...
export default function MyTAAssignmentsPage() {
  ...
  if (!session) {
    return (
      <div className="p-8">
        <h1 className="text-2xl font-bold">Please sign in to view your TA assignments</h1>
      </div>
    );
  }
    ...
    <div className="p-8">
      ...
      {assignments.length === 0 ? (
        <div className="text-center p-8 border rounded-lg">
          ...
          <p className="text-muted-foreground mt-2">You are not assigned as a TA for any assignments in this team.</p>
        </div>
      ) : (
