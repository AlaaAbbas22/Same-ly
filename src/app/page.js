        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-5xl md:text-6xl font-bold mb-2">
              Same'ly{" "}
              <span className="text-4xl md:text-5xl font-light">(سمّعلي)</span>
            </h1>
          ...
          {/* Hero Section */}
          <div className="bg-white dark:bg-gray-900 backdrop-blur-sm rounded-xl p-6 md:p-8 mb-10 shadow-lg">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">
              Organize, Track, and Perfect Your Quran Journey
            </h2>
            <p className="text-lg mb-6">
              Same'ly helps you create and manage Halaqas, assign portions for
              memorization and recitation, track progress, and provide feedback
              - all in one place.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white dark:bg-gray-900 backdrop-blur-sm p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3">Team Management</h3>
              <p>
                Create and organize Halaqas with students and teaching
                assistants.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-900 backdrop-blur-sm p-6 rounded-lg shadow-md">
              ...
              <p>
                Assign specific Quran portions for memorization or recitation
                practice.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-900 backdrop-blur-sm p-6 rounded-lg shadow-md">
